...
class Labour1Fragment : Fragment(), ItemsInterClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_labour1, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment Labour1Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Labour1Fragment().apply {
