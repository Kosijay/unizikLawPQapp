 ...
 * Use the [CourseFragment300Second.newInstance] factory method to
 * create an instance of this fragment.
 */
class CourseFragment300Second : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_course_300_second, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        // getting the employeelist
        val courseList= FirstOrSecond.getCourseData300II()
        ...
        val recyclerView: RecyclerView =view.findViewById(R.id.recycleViewCourse300II)
    ...
    companion object {
         ...
         * @return A new instance of fragment CourseFragment300Second.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CourseFragment300Second().apply {
